...
def main():
    ...
    # STEP 1: ASK FOR API DETAILS
    name = input("API Name: ")
    apiKey = input("API Key (if the API does not require a key, press ENTER): ") # leave empty if the API does not require a key
    openaiKey = input("OpenAI Key: ")
    nbMutations = int(input("Number of Mutations: "))
